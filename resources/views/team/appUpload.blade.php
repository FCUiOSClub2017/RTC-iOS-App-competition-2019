        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-xl-4">
                <div class="container">
                    ...
                    <div class="row justify-content-around py-2">
                        <div class="col-12">
                            <a>請於2018/7/20 23:59:59 前繳交App作品，作品應包含可在移動裝置中運行的應用程式，包含 APP 操作過程影片檔、現場簡報檔、 SOURCE CODE 及 APP 宣傳文件，進入決賽公布後，參賽隊伍可對作品進行優化，但不能變更作品主題和內容，並根據決賽要求提供最終作品，參賽作品以提交截止日期前提交的最後一版為準。</a>
                        </div>
                    </div>
                </div>
            </div>
