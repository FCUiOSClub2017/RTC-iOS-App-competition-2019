@extends('layouts.app') @section('content') @php $randomStr1 = str_random(10); $randomStr2 = str_random(10); @endphp
        ...
        <div class="col">
            <div class="list-group">
                ...
                <a class="list-group-item list-group-item-action flex-column align-items-start">
                    {!! Form::open(['route' => 'admin.config.deadline.register','onSubmit'=>"axios.post(this.action,{date:this.date.value}).then((response)=>{\$('#$randomStr1').text(response.data.date)});return false;"]) !!}
                    <div class="row justify-content-between align-items-center">
                        <div class="col">註冊截止時間： <span id="{{$randomStr1}}">{{Setting::get('register_deadline',"2018-05-21 23:59:59")}}</span></div>
                        <div class="col-auto">
                ...
                <a class="list-group-item list-group-item-action flex-column align-items-start">
                    {!! Form::open(['route' => 'admin.config.deadline.proposal','onSubmit'=>"axios.post(this.action,{date:this.date.value}).then((response)=>{\$('#$randomStr2').text(response.data.date)});return false;"]) !!}
                    <div class="row justify-content-between align-items-center">
                        <div class="col">企劃書上傳截止時間： <span id="{{$randomStr2}}">{{Setting::get('proposal_deadline',"2018-05-23 23:59:59")}}</span></div>
                        <div class="col-auto">
